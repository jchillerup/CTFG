            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12" style="margin-top: 12px;">
                    <div id="client-pagination"
                        style="display:none; align-items:center; justify-content: space-between; gap: 12px; flex-wrap: wrap; border-top: 1px solid #e9ecef; padding-top: 12px;">
                        <div style="display:flex; align-items:center; gap: 8px;">
                            <label for="perPage" style="margin:0; font-size: 14px; color:#495057;">Per page</label>
                            <select id="perPage"
                                style="padding:6px 8px; border:1px solid #ced4da; border-radius:6px; background:white;">
                        ...
                        <div style="display:flex; align-items:center; gap: 8px;">
                            <button id="prevPage" type="button"
                                style="padding:6px 10px; border:1px solid #ced4da; background:white; border-radius:6px; cursor:pointer;">Prev</button>
                            <span id="pageInfo"
                                style="min-width: 120px; text-align:center; font-size: 14px; color:#495057;">Page 1 /
                                1</span>
                            <button id="nextPage" type="button"
                                style="padding:6px 10px; border:1px solid #ced4da; background:white; border-radius:6px; cursor:pointer;">Next</button>
                        </div>
                    </div>
