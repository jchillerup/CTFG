...
@section('scripts')
            ...
            for (var i = 0; i < projects.length; i++) {
                ...
                var entry = {
                    ...
                    content: '<div id="content">' +
                        '<div id="siteNotice">' +
                        "</div>" +
                        '<h3 id="firstHeading" class="firstHeading"><a class="location" title="Go to listing profile" href="' +
                        url + '">' + project + '</a></h3>' +
                        '<div id="bodyContent">' +
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key={{ $gMapsApiKey }}&callback=initMap&libraries=places"></script>
