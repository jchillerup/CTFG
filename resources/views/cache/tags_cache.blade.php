    ...
    <ul class="nav flex-column" id="nav_accordion">
        <li class="nav-item has-subtag">
            ...
            <a class="nav-link subtag-button">
                <span class="text-sm" style="margin-top: -15px !important;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-chevron-right" viewBox="0 0 16 16" style="margin-top: -15px !important;">
            ...
            <ul class="subtag collapse ">
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Sustainable cities and communities"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Good health and well-being"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/learning difficulties"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/criminal justice reform"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Affordable and clean energy"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Decent work and economic growth"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/private data public good"
                        title="private data public good">
                        <span class="text-sm cat-wrap ">
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Reduced inequalities"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Clean water and sanitation"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Industry, innovation, and infrastructure"
        ...
        <li class="nav-item has-subtag">
            ...
            <ul class="subtag collapse ">
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/connecting current features"
                        title="connecting current features">
                        <span class="text-sm cat-wrap ">
        ...
        <li class="nav-item has-subtag">
            <a class="nav-link" href="/listing-tag/Sustainable Development Goals"
            ...
            <ul class="subtag collapse ">
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Responsible consumption and production"
                ...
                <li class="nav-item has-subtag ">
                    <a class="nav-link overlay" href="/listing-tag/Peace, justice, and strong institutions"
            ...
            element.addEventListener('click', function(e) {
                ...
                if (nextEl) {
                    ...
                    if (nextEl.classList.contains('show')) {
                        ...
                        mycollapse.show();
                        var opened_subtag = parentEl.parentElement.querySelector(
                        '.subtag.show');
