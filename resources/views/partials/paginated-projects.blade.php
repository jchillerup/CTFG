...
@foreach ($projects as $project)
    <div class="listing-item-container list-layout"
        style="background: #ffffff; border: 1px solid #e9ecef; box-shadow: 0 2px 8px rgba(0,0,0,0.08);
         margin-bottom: 32px; padding: 24px; border-radius: 12px; transition: all 0.3s ease;">
            ...
            <div class="listing-item-content" style="flex: 1; padding: 0; min-width: 0;">
                <div class="listing-title" style="margin-bottom: 16px;">
                    ...
                    @if (!empty(@$project->location->first()->name))
                        <div
                            style="color: #495057; font-size: 15px; margin-bottom: 12px; display: flex; align-items: center;">
                ...
                @if (@$project->tags->count() > 0)
                    <div style="margin-bottom: 14px;">
                        <strong
                            style="color: #495057; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Tags:
                        </strong>
                ...
                @if (!empty($languages))
                    <div style="margin-bottom: 14px;">
                        <strong
                            style="color: #495057; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Languages:
                        </strong>
                        <div style="margin-top: 8px;">
                ...
                @if (!empty(@$project->organization_type))
                    <div style="margin-bottom: 14px;">
                        <strong
                            style="color: #495057; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Organization
                            Type:</strong>
                        <div style="margin-top: 8px;">
                ...
                @if (!empty($project->website_url))
                    <div class="listing-footer"
                        style="margin-top: 18px; padding-top: 18px; border-top: 2px solid #e9ecef;">
                        <a href="{{ $project->website_url }}" target="_blank" rel="noopener noreferrer"
                            style="color: #198754; text-decoration: none; font-size: 15px; font-weight: 500; display: inline-flex; align-items: center; transition: color 0.2s ease;"
                            onmouseover="this.style.color='#157347'" onmouseout="this.style.color='#198754'">
