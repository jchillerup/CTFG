            ...
            <div class="listings-container list-layout">
                ...
                <nav class="sidebar py-2 mb-4">
                    <ul class="nav flex-column" id="nav_accordion">
                        <li class="nav-item">
                            <a class="nav-link" href="/listing-category/program">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="listings-container list-layout">
                ...
                <nav class="sidebar py-2 mb-4">
                    <ul class="nav flex-column" id="nav_accordion">
                        <li class="nav-item">
                            <a class="nav-link" href="/listing-category/organization">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="listings-container list-layout">
                ...
                <nav class="sidebar py-2 mb-4">
                    <ul class="nav flex-column" id="nav_accordion">
                        <li class="nav-item">
                            <a class="nav-link" href="/listing-category/resource">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="listings-container list-layout">
                ...
                <p>Welcome to our knowledge hub featuring programs, organizations, and resources focused on digital democracy and civic technology.</p>
            </div>
        </div>
    </div>
@endsection
